...
$sql10=mysqli_query($connection,"select * from ProjektuPrivilegijos WHERE VartotojoID=$ziurimoid");
$dalyvauja = mysqli_num_rows($sql10);
...
<td><b>Email</b></td>
<td class="darbuotojas_td">
<div id="pastas_<?php echo $id; ?>" class="text"><a href="mailto:<?php echo $pastas; ?>"> <?php echo $pastas; ?></a></div> 
</td>
</tr>
</table>
...
<div class='statistika'>
    Number of projects participating: <br>
</div>
