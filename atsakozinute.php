        ...
        <div class='info' style='overflow-x:scroll; text-align:center;'>         
              ...
              <div class='desinys' style='text-align:center; width:95%;'>    
                  <form action='issiunciazinute.php' method=POST>
                       ...
                       <textarea rows="4" cols="50"  name='tekstas' style='text-align:top; width:70%; height:200px; margin-top:20px; margin-left:20px; float:left;' placeholder="enter your message here"></textarea>
