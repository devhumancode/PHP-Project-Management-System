...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql=mysqli_query($connection,"UPDATE ProjektuUzduotys SET `SukureID` = '$gavejas', `DarbuotojoID` = '$siuntejas', `AtsakymoTekstas` = '$tekstas', `Failas` = '$reikiamas', `Busena` = '0' WHERE ID = $uid;");
